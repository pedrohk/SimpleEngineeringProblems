...
class DPK16Test extends AnyFunSuite {
  ...
  test("DPK16_impl_05") {
    runGame(new DPK16_impl_05.Game)
  }

  test("DPK16_impl_06") {
    runGame(new DPK16_impl_06.Game)
  }

  test("DPK16_impl_07") {
    runGame(new DPK16_impl_07.Game)
  }

  test("DPK16_impl_08") {
    runGame(new DPK16_impl_08.Game)
  }

  test("DPK16_impl_09") {
    runGame(new DPK16_impl_09.Game)
  }

  test("DPK16_impl_10") {
    runGame(new DPK16_impl_10.Game)
  }
}
