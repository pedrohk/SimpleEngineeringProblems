...
class DPK15Test extends AnyFunSuite {
  ...
  test("DPK15_impl_07 should work correctly") {
    val john = new DPK15_impl_07.Person("John", 30)
    val paul = new DPK15_impl_07.Person("Paul", 28)
    val george = new DPK15_impl_07.Person("George", 27)
    val ringo = new DPK15_impl_07.Person("Ringo", 35)
    ...
    val most = DPK15_impl_07.SocialAnalytics.mostFriends(people)
    val least = DPK15_impl_07.SocialAnalytics.leastFriends(people)

    assert(most.getName() == "John")
    assert(least.getName() != null)

    val oldestFriend = DPK15_impl_07.SocialAnalytics.oldestFriend(people)
    assert(oldestFriend.getAge() == 35)
  }

  test("DPK15_impl_08 should work correctly") {
    val john = new DPK15_impl_08.Person("John", 30)
    val paul = new DPK15_impl_08.Person("Paul", 28)
    val george = new DPK15_impl_08.Person("George", 27)
    val ringo = new DPK15_impl_08.Person("Ringo", 35)
    ...
    val most = DPK15_impl_08.SocialAnalytics.mostFriends(people)
    val least = DPK15_impl_08.SocialAnalytics.leastFriends(people)

    assert(most.getName() == "John")
    assert(least.getName() != null)

    val oldestFriend = DPK15_impl_08.SocialAnalytics.oldestFriend(people)
    assert(oldestFriend.getAge() == 35)
  }

  test("DPK15_impl_09 should work correctly") {
    val john = new DPK15_impl_09.Person("John", 30)
    val paul = new DPK15_impl_09.Person("Paul", 28)
    val george = new DPK15_impl_09.Person("George", 27)
    val ringo = new DPK15_impl_09.Person("Ringo", 35)
    ...
    val most = DPK15_impl_09.SocialAnalytics.mostFriends(people)
    val least = DPK15_impl_09.SocialAnalytics.leastFriends(people)

    assert(most.getName() == "John")
    assert(least.getName() != null)

    val oldestFriend = DPK15_impl_09.SocialAnalytics.oldestFriend(people)
    assert(oldestFriend.getAge() == 35)
  }

  test("DPK15_impl_10 should work correctly") {
    val john = new DPK15_impl_10.Person("John", 30)
    val paul = new DPK15_impl_10.Person("Paul", 28)
    val george = new DPK15_impl_10.Person("George", 27)
    val ringo = new DPK15_impl_10.Person("Ringo", 35)
    ...
    val most = DPK15_impl_10.SocialAnalytics.mostFriends(people)
    val least = DPK15_impl_10.SocialAnalytics.leastFriends(people)

    assert(most.getName() == "John")
    assert(least.getName() != null)

    val oldestFriend = DPK15_impl_10.SocialAnalytics.oldestFriend(people)
    assert(oldestFriend.getAge() == 35)
  }
